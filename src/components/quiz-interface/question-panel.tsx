        ...
        <div className="flex justify-between items-center mb-9 border-b pb-3">
          ...
          <div className="flex gap-2 items-center">
            ...
            <Button
              ...
              className={`gap-2 text-sm font-medium border px-3 py-1 rounded-md transition-all duration-200 ${
                getQuestionStatus(currentQuestion, subjectInfo) === "flagged"
          ...
          {currentQuestionData?.question_type === "MCQ"
            ? currentQuestionData.options.map((option: any, index: number) => (
                <div
                  ...
                  className={`p-4  rounded-md border text-sm cursor-pointer transition duration-200 flex items-start gap-3 ${
